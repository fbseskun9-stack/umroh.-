...
// Fungsi untuk pancingan internal (Self-Ping)
const URL_APP = `https://${process.env.RENDER_EXTERNAL_HOSTNAME}.onrender.com`;
setInterval(() => {
    if (process.env.RENDER_EXTERNAL_HOSTNAME) {
        const fetch = require('node-fetch'); // Pastikan install: npm install node-fetch@2
